...
class FeatureVector():
    ...
    images = ['004_res.png', '001_res.png', '002_res.png', '003_res.png', '005_res.png', '006_res.png', '007_res.png',
              '008_res.png']
    ...
    def features(self, bgr):
        ...
        mat = graycomatrix(gray_img, distances=[1], angles=[0, np.pi / 4, np.pi / 2, 3 * np.pi / 4], levels=256)
        normed = True
        ...
        energy = graycoprops(mat, 'energy')
        contrast = graycoprops(mat, 'contrast')
        homogeneity = graycoprops(mat, 'homogeneity')
        correlation = graycoprops(mat, 'correlation')
        ...
        name = ['blue_mean', 'blue_standard deviation', 'blue_skewness', 'blue_kurtosis', 'green_mean',
                'green_standard deviation', 'green_skewness', 'green_kurtosis', 'red_mean', 'red_standard deviation',
                'red_skewness', 'red_kurtosis', 'energy_horizontal', 'energy_diagonal_1', 'energy_vertical',
                'energy_diagonal_2', 'contrast_horizontal', 'contrast_diagonal_1', 'contrast_vertical',
                'contrast_diagonal_2', 'homogeneity_horizontal', 'homogeneity_diagonal_1', 'homogeneity_vertical',
                'homogeneity_diagonal_2', 'correlation_horizontal', 'correlation_diagonal_1', 'correlation_vertical',
                'correlation_diagonal_2', 'entropy_horizontal', 'entropy_diagonal_1', 'entropy_vertical',
                'entropy_diagonal_2']
